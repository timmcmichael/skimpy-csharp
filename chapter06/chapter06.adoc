...
// TODO: Debugging videos in VS Code, VS, and Rider

.Time To Watch!
****
Debugging in C# with VS Code [COMING SOON!]
...
// * Starter code: {github-base}/{github-folder}/MethodDebugging.cs[`MethodDebugging.cs`^]
// * Completed code: {github-base}/{github-folder}/MethodDebuggingFinal.cs[`MethodDebuggingFinal.cs`^]
...
// TODO: Update this AI song example
We can ask a generative AI tool to write song lyrics about https://www.estrellamountain.edu[Estrella Mountain Community College^], for example, and it will produce a link:chapter06/ai_song.html[new song for us^].
...
// TODO: Copilot videos for VS and Rider. VS Code video might still be fine.
.Time To Watch!
****
